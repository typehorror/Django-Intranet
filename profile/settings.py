...
# Default email from is used for every email sent from profile
# application. If you set one in your main settings file
# it will overide this configuration.
try:
    from django.conf.settings import DEFAULT_EMAIL_FROM
except ImportError:
